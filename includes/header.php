...
<div class="app-shell">
  <div class="app-frame">
    ...
    <header class="app-header d-flex align-items-center justify-content-between flex-wrap gap-3 mb-4">
      ...
      <nav class="main-nav">
        <ul class="nav">
          <li class="nav-item"><a class="nav-link <?= $halamanAktif === 'beranda' ? 'active' : '' ?>" href="index.php">Beranda</a></li>
          <li class="nav-item"><a class="nav-link <?= $halamanAktif === 'menu' ? 'active' : '' ?>" href="menu.php">Produk</a></li>
          <li class="nav-item"><a class="nav-link <?= $halamanAktif === 'tentang' ? 'active' : '' ?>" href="tentang.php">Tentang Kami</a></li>
          <?php if (sudahLogin()): ?>
          <li class="nav-item"><a class="nav-link <?= $halamanAktif === 'pesanan' ? 'active' : '' ?>" href="pesanan_saya.php">Pesanan Saya</a></li>
          <?php endif; ?>
        </ul>
      </nav>

      <div class="d-flex align-items-center gap-2">
        <form action="menu.php" method="get" class="d-none d-md-flex" style="width:220px;">
        ...
        <a href="keranjang.php" class="icon-btn position-relative" aria-label="Keranjang">
        ...
        <?php if (sudahLogin()): ?>
          <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <?php endif; ?>
              <li><a class="dropdown-item" href="pesanan_saya.php"><i class="bi bi-receipt me-2"></i>Pesanan Saya</a></li>
